  ...
  return (
    <aside className="w-full md:w-96 bg-[#16171E] border-l border-[#2A2B36] flex flex-col h-full absolute md:relative z-40 right-0 top-0 overflow-hidden shadow-2xl">
      <div className="p-6 border-b border-[#2A2B36]/50 flex justify-between items-center relative">
        <div>
          <h2 className="text-xl font-bold text-white mb-1">Create New Entry</h2>
          <p className="text-xs text-gray-400">Fill in the technical parameters for the new data node.</p>
        </div>
      ...
      <div className="p-6 flex-1 overflow-y-auto space-y-6">
        <div>
          <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Service Identity</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Zone</label>
          ...
          <div>
            <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Priority</label>
            <div className="relative">
              <select className="w-full bg-[#111115] border border-[#2A2B36] rounded-lg px-3 py-2.5 text-sm text-gray-200 appearance-none focus:outline-none focus:border-[#635BFF]">
                <option>High</option>
        ...
        <div>
          <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Deployment Date</label>
          <div className="relative">
            <input
              type="text"
        ...
        <div>
          <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Configuration Hash</label>
          <input
            type="text"
            defaultValue="0x..."
        ...
        <div>
           <label className="block text-[10px] uppercase font-bold tracking-widest text-gray-500 mb-2">Node Description</label>
           <div className="border border-[#2A2B36] rounded-lg bg-[#111115] overflow-hidden focus-within:border-[#635BFF] transition-colors">
              <div className="border-b border-[#2A2B36] px-3 py-2 flex gap-3 text-gray-400">
                 <button className="hover:text-white font-bold text-xs"><span style={{fontFamily: 'serif'}}>B</span></button>
                 <button className="hover:text-white italic text-xs"><span style={{fontFamily: 'serif'}}>I</span></button>
