  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col h-full">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
        ...
        <button className="bg-[#635BFF] hover:bg-[#524ae6] text-white px-5 py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 w-full sm:w-auto sm:shrink-0">
          <svg
            className="w-5 h-5"
            fill="none"
            viewBox="0 0 24 24"
