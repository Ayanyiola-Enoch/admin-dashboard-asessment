...
const IssueManagement = () => {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-[#111115]">
      {/* Main Issue Board */}
      <div className="flex-1 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] pl-4 pr-4 md:pr-8">
        {/* Header Title */}
        <div className="mt-4 mb-6">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-widest uppercase text-white mb-2">
            Issue Management
          </h1>
          <p className="text-gray-400 text-sm mt-2 md:mt-4">
        ...
        <div className="flex gap-6 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] pb-4">
          ...
          <div className="w-80 shrink-0 flex flex-col gap-4">
            ...
            {/* Ticket Card 1 */}
            <div
              onClick={() => handleTicketClick("NX-2041")}
              className="bg-[#1C1D26] border border-[#2A2B36] rounded-xl p-4 hover:border-[#635BFF] transition-colors cursor-pointer outline-1 outline-[#1C1D26] focus:outline-[#635BFF]"
            >
            ...
            {/* Ticket Card 2 */}
            <div
              onClick={() => handleTicketClick("NX-2045")}
              className="bg-[#14151C] border border-[#2A2B36] border-dashed rounded-xl p-4 opacity-70 cursor-pointer hover:border-[#635BFF] transition-colors"
            >
              <div className="flex justify-between items-center mb-3">
          ...
          <div className="w-80 shrink-0 flex flex-col gap-4">
            ...
            {/* Ticket Card 3 */}
            <div
              onClick={() => handleTicketClick("NX-1992")}
              className="bg-[#1C1D26] border border-[#2A2B36] rounded-xl p-4 hover:border-[#635BFF] transition-colors cursor-pointer"
            >
              <div className="flex justify-between items-center mb-3">
      ...
      {selectedTicket && (
        <>
          ...
          <div className="fixed inset-y-0 right-0 w-80 sm:w-96 lg:w-100 border-l border-[#2A2B36] bg-[#111115] flex flex-col overflow-hidden z-50 shadow-2xl md:relative md:inset-auto md:shadow-none translate-x-0 transition-transform duration-300">
            {/* Header */}
                ...
                <div className="mb-8">
                  ...
                  <div className="text-sm text-gray-300 space-y-3 leading-relaxed">
                    <p>
                      ...
                      &gt;450ms across all microservices in the US-East-1
                      region. Traffic shaping rules appear to be misconfigured
                      after the last rollout.
                    </p>
                    <p>
                      Investigation into the load balancer logs shows a
                      significant increase in 504 errors on the edge nodes.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="bg-[#1C1D26] border border-[#2A2B36] p-4 rounded-xl flex gap-3 relative">
                      ...
                      <div className="w-full pl-3">
                        ...
                        <p className="text-xs text-gray-400">
                          Checking the ingress controller logs now. It seems
                          related to the new proxy configuration.
                        </p>
                      </div>
                    </div>
